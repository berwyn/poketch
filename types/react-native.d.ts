 ...
 * THIS IS CUSTOMISED
 * 
 * The DT definitions of React Native don't include the Platform module, so we're going
 * to use this file to figure out that gap, as well as any others, before creating a typings
 * module to replace the DT project
 */
